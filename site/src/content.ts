...
export const FAQ: FaqItem[] = [
  ...
  {
    q: "下载后打不开，或者被 Windows 拦住了？",
    a: "两种情况，症状不一样。①弹出「Windows 已保护你的电脑」：程序未做代码签名，点「更多信息 → 仍要运行」即可；不放心的话 Release 页附有 SHA256，可以自己核对。②双击完全没反应：多半是缺 Microsoft Edge WebView2 运行时（微软官方免费组件，Windows 11 与较新的 Windows 10 都自带）。这种情况程序会弹窗说明原因，不会静默失败 —— 如果连弹窗都没有，那是被安全软件拦在了启动之前。",
  },
  {
    q: "现在能用了吗？",
    a: RELEASE.url

 ...
 * 一个卖「一开口就是准的」的工具，首屏不出现那个音高显示是说不通的。
 *
    ...
    <section className="hero" id="top">
      <div className="hero-text">
        ...
        {/* ⚠️ 首屏这句必须**两根柱子都带到**，而且**两根都得是现在就能用的**。
            ...
            声线那块还没有；而写"变成某个指定的人"就是承诺一个还没发布的
            东西 —— 那和骗没有区别。

            「换一把嗓子」正好卡在真话这一边：实时声线塑形已经发布，
            它做得到「像另一个人」。做不到的那一档（像某个指定的人）
            在下面的功能区里明确标着开发中。 */}
        <h1>
          一开口就是准的，
          <br />
        ...
        <p className="lede">
          ...
          直接回到耳返里，实测 {FACTS.latencyMs} 毫秒。声线也能当场换：
          更细、更厚、更亮，<strong>都不动音高</strong>。
          干声原样落盘，随时能重来。
        </p>
